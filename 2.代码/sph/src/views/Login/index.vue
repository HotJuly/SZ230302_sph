          ...
          <div class="content">
            <form action="##">
              <div class="input-text clearFix">
                <span></span>
                <input v-model.trim="phone" type="text" placeholder="邮箱/用户名/手机号">
              </div>
              <div class="input-text clearFix">
                <span class="pwd"></span>
                <input v-model.trim="password" type="text" placeholder="请输入密码">
              </div>
  ...
  methods: {
    async login() {
      ...
      if(!phoneReg.test(phone)){
        this.$message.error('手机账号格式不对,请检查');
        return;
      }

      if(!pwdReg.test(password)){
        this.$message.error('密码不正确,请检查');
        return;
      }
      
      // login接口->使用账号密码与服务器兑换当前账号的token信息
